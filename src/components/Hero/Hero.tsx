  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        >
              <span className="text-neutral-white text-lg sm:text-xl font-medium">Hello.</span>
              <span className="w-2 h-2 rounded-full" style={{ backgroundColor: '#03D6C4' }}></span>
        </motion.div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, width: '100%' }}
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-neutral-white mb-3"
            >
              I'm Jamanudeen
            </motion.h1>
            ...
            <motion.h2
              ...
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-white mb-6"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl text-neutral-white/90 mb-4 leading-relaxed max-w-2xl mx-auto lg:mx-0"
            >
            ...
            <motion.p
              ...
              className="text-sm sm:text-base md:text-lg text-neutral-white/70 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0"
            >
        ...
        <motion.div
            ...
            >
              <button
                ...
                className="px-8 py-3 text-white font-semibold rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 w-full sm:w-auto"
                style={{
              ...
              <Link
                href="/blog"
                className="px-8 py-3 border-2 border-neutral-white text-neutral-white font-semibold rounded-lg hover:bg-neutral-white/10 transition-all duration-200 hover:scale-105 active:scale-95 text-center w-full sm:w-auto"
              >
                Read Blog
              </Link>
            </motion.div>
          ...
          >
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[500px] lg:h-[500px]">
              ...
              <div className="absolute -left-8 top-1/2 -translate-y-1/2 hidden lg:block">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="text-neutral-white/30">
